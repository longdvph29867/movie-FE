...
console.log(listCinemaChain);
            ...
            return {
              ...
              label: (
                <div className="text-left w-60">
                  <h3 className="text-base font-bold text-green-500 truncate">
              ...
              children: (
                <div className="w-full h-[700px] overflow-x-scroll">
                  {listShowingByBranch.map((item, index) => (
                    <ItemTabMovie key={index} movie={item} />
                  ))}
                </div>
              ),
            };
  ...
  return (
    <div className="py-5 tabs-movie-home">
