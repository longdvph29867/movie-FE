...
const Footer = () => {
  return (
    <>
      <footer className="text-[#abb7c4] text-sm font-['Nunito'] md:text-left text-center bg-[url('/public/banner-bg.jpeg')] bg-cover">
  <div className="container mx-auto">
    <div className="flex flex-col items-center gap-5 py-20 lg:gap-16 md:flex-row md:items-stretch">
      ...
      <div className="grid gap-8 md:w-2/4 sm:gap-3 sm:grid-cols-3 ">
        ...
        <div>
          <h4 className="text-lg font-bold text-white mb-7">Chính sách</h4>
          <ul className="space-y-1.5">
            <li>
      ...
      <div className="md:w-1/4">
        <h4 className="text-lg font-bold text-white mb-7">Đăng ký nhận tin</h4>
